...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  final _fullNameController = TextEditingController(); // Bộ điều khiển nhập họ tên
  final _emailController = TextEditingController(); // Bộ điều khiển nhập email
  final _phoneController = TextEditingController(); // Bộ điều khiển nhập số điện thoại
  final _addressController = TextEditingController(); // Bộ điều khiển nhập địa chỉ mặc định
  final _passwordController = TextEditingController(); // Bộ điều khiển nhập mật khẩu mới
      ...
      builder: (ctx) {
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            ...
            child: Form(
              key: _formKey, // Gán key đã khai báo để quản lý trạng thái của Form này
              child: Column(
                mainAxisSize: MainAxisSize.min, // Thu nhỏ kích thước cột vừa khít với các phần tử con
                children: [
                  ...
                  TextFormField(
                    ...
                    keyboardType: TextInputType.emailAddress, // Tối ưu hóa bàn phím nhập email
                  ),
                  ...
                  TextFormField(
                    ...
                    keyboardType: TextInputType.phone, // Tối ưu hóa bàn phím nhập số điện thoại
                  ),
                  const SizedBox(height: 12),
                  ...
                  TextFormField(
                    ...
                    obscureText: true, // Ẩn các ký tự mật khẩu (hiển thị dạng dấu chấm)
                  ),
                ],
              ),
            ),
          ...
          actions: [
            // Nút hủy bỏ
            TextButton(
              onPressed: () => Navigator.of(ctx).pop(), // Đóng hộp thoại mà không làm gì cả
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.stretch, // Căn chỉnh các thành phần con kéo giãn theo chiều ngang
            children: [
                ...
                child: Column(
                  children: [
                    ...
                    CircleAvatar(
                      ...
                      backgroundColor: theme.colorScheme.primary.withOpacity(0.1), // Màu nền mờ dựa theo tông màu chính
                      child: Text(
                        ...
                        style: TextStyle(
                          ...
                          color: theme.colorScheme.primary, // Chữ có màu chính của Theme ứng dụng
                        ),
                      ),
                    ),
                    const SizedBox(height: 12),
                  ...
                  child: Column(
                    children: [
                      ...
                      ListTile(
                        ...
                        leading: const Icon(Icons.email_outlined), // Icon thư bên trái
                        title: const Text('Email'),
                        subtitle: Text(user.email ?? 'Chưa cập nhật'), // Hiển thị email hoặc chữ 'Chưa cập nhật'
                      ),
                      ...
                      ListTile(
                        contentPadding: EdgeInsets.zero,
                        leading: const Icon(Icons.phone_outlined), // Icon điện thoại
              ...
              ListTile(
                ...
                trailing: const Icon(Icons.chevron_right), // Icon mũi tên bên phải báo hiệu có thể click chuyển trang
                onTap: () {
              ...
              ListTile(
                ...
                onTap: _showEditProfileDialog, // Gọi hàm mở Dialog khi click vào dòng này
              ),
              ...
              ElevatedButton.icon(
                style: ElevatedButton.styleFrom(
                  backgroundColor: Colors.red[800], // Màu nền của nút (đỏ đậm báo hiệu nguy hiểm/hủy bỏ)
